        ...
        <div className="relative z-10 grid min-h-[585px] gap-10 lg:min-h-[calc(100svh-190px)] lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
          <div className="flex h-full flex-col">
            ...
            <div className="mt-16 lg:mt-20">
              ...
              <h1 className="mt-3 text-5xl font-medium leading-[1.1] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
                AI 导购 /<br />客服知识库
              </h1>
          ...
          <div className="glass-card self-end rounded-[26px] p-6 text-black sm:p-7">
