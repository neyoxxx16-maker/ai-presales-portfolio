  ...
  return (
    <section className="mx-auto max-w-[1520px] px-2 pt-5 sm:px-3 lg:px-4">
      <div className="sky-panel min-h-[650px] rounded-[30px] px-6 py-7 text-white shadow-soft sm:px-10 lg:min-h-[calc(100svh-130px)] lg:px-14 lg:py-10">
        <div className="relative z-10 grid min-h-[585px] gap-10 lg:min-h-[calc(100svh-190px)] lg:grid-cols-[1.15fr_0.85fr] lg:items-stretch">
          <div className="flex h-full flex-col">
            ...
            <div className="mt-16 lg:mt-20">
              ...
              <h1 data-hero-reveal className="mt-3 text-5xl font-medium leading-[1.13] tracking-[-0.018em] sm:text-6xl lg:text-7xl">
                AI 导购 /<br />客服知识库
              </h1>
          ...
          <div className="glass-card relative self-end rounded-[26px] p-6 text-black sm:p-7 lg:left-3 lg:top-12 lg:self-start">
